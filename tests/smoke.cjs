...
const demo=fs.readFileSync('assets/demo-v4.js','utf8');for(const file of ['assets/journey-ui.css','assets/journey-ui.js','assets/visual-v1.css','assets/result-rings.css','assets/result-rings.js','assets/profile-visuals.css','assets/profile-visuals.js'])assert(demo.includes(file),`${file} deve ser carregado`);
for(const file of ['assets/journey-ui.css','assets/journey-ui.js','assets/visual-v1.css','assets/result-rings.css','assets/result-rings.js','assets/profile-visuals.css','assets/profile-visuals.js','docs/perfis-visuais-v1.md'])assert(fs.existsSync(file),`${file} deve existir`);
...
console.log(`OK: ${D.questions.length} itens, jornada V4, tema visual V1, anéis e camada visual dos 7 perfis consistentes.`);
